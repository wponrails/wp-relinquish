...
Version: 0.0.1-alpha
Description: With this WordPress plugin a WP site can "relinquish" content  serving to an extertnal system, for instance a Rails application with the wp-connector gem.
Author: Hoppinger
